...
public class BackgroundRenderer {
    ...
    // Shader names
    private static final String VERTEX_SHADER_NAME = "arcore-example/screenquad.vert";
    private static final String FRAGMENT_SHADER_NAME = "arcore-example/screenquad.frag";

    private static final String VERTEX_SHADER_FILENAME = "shaders/screenquad.vert";
    private static final String FRAGMENT_SHADER_FILENAME = "shaders/screenquad.frag";
    ...
    private GLSLProgram quadProgram;
    ...
    public void init(Context context) {
        ...
        quadProgram = new GLSLProgram("arcore-example/BackgroundRenderer", vertexShader, fragmentShader);
        quadProgram.declareAttribute(GLSLProgram.POSITION, "a_Position");
        quadProgram.declareAttribute(GLSLProgram.TEXCOORD, "a_TexCoord");
    }
    ...
    private void draw() {
        ...
        GLES20.glVertexAttribPointer(
                quadProgram.getAttributeLocation(GLSLProgram.POSITION), COORDS_PER_VERTEX,
                GLES20.GL_FLOAT, false, 0, quadCoords);

        // Set the texture coordinates.
        GLES20.glVertexAttribPointer(
                quadProgram.getAttributeLocation(GLSLProgram.TEXCOORD), TEXCOORDS_PER_VERTEX,
                GLES20.GL_FLOAT, false, 0, quadTexCoords);


        // Enable vertex arrays
        GLES20.glEnableVertexAttribArray(quadProgram.getAttributeLocation(GLSLProgram.POSITION));
        GLES20.glEnableVertexAttribArray(quadProgram.getAttributeLocation(GLSLProgram.TEXCOORD));

        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_STRIP, 0, 4);

        // Disable vertex arrays
        GLES20.glDisableVertexAttribArray(quadProgram.getAttributeLocation(GLSLProgram.POSITION));
        GLES20.glDisableVertexAttribArray(quadProgram.getAttributeLocation(GLSLProgram.TEXCOORD));

        // Restore the depth state for further drawing.
        GLES20.glDepthMask(true);
        GLES20.glEnable(GLES20.GL_DEPTH_TEST);

        GLUtils.checkGLError(TAG, "BackgroundRendererDraw");
    }
